 ...
 */
  ...
  *
  * \brief This file contains a sequential implementation of the
 ...
 */
struct corpus_type {
  size_t nwords, ndocs, ntokens; // number of words, docs tokens in the corpus
  std::vector< token_type > tokens; // word_id, doc_id pair in the corpus
  std::vector<std::string> dictionary; // words in the corpus
  std::vector< word_id_type > ntokens_in_doc; // number of words in each doc
